    ...
    <div>
      ...
      <div className="table-responsive">
        {departamentoList && departamentoList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('idGestorDepartamento')}>
                  Id Gestor Departamento <FontAwesomeIcon icon={getSortIconByFieldName('idGestorDepartamento')} />
                </th>
            ...
            <tbody>
              {departamentoList.map((departamento, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{departamento.idGestorDepartamento}</td>
                  <td>{departamento.nome}</td>
                  <td>{departamento.descricao}</td>
                  <td>
                    {departamento.gestorDepartamento ? (
                      <Link to={`/gestor-departamento/${departamento.gestorDepartamento.id}`}>{departamento.gestorDepartamento.id}</Link>
                    ) : (
                      ''
                    )}
                  </td>
          ...
          !loading && <div className="alert alert-warning">Nenhum Departamento encontrado</div>
        )}
      </div>
      {totalItems ? (
