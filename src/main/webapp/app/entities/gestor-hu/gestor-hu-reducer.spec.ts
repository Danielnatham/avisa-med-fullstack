...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './gestor-hu.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GESTORHU_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GESTORHU actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GESTORHU actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_GESTORHU actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_GESTORHU actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GESTORHU actions', async () => {
      const arg = 42666;
