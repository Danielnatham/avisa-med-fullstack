...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './cidadao-identificado.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CIDADAOIDENTIFICADO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CIDADAOIDENTIFICADO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CIDADAOIDENTIFICADO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CIDADAOIDENTIFICADO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CIDADAOIDENTIFICADO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CIDADAOIDENTIFICADO actions', async () => {
      const arg = 42666;
