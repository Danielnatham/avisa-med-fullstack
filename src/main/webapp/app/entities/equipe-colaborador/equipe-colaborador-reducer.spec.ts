...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './equipe-colaborador.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EQUIPECOLABORADOR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EQUIPECOLABORADOR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EQUIPECOLABORADOR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_EQUIPECOLABORADOR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_EQUIPECOLABORADOR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EQUIPECOLABORADOR actions', async () => {
      const arg = 42666;
