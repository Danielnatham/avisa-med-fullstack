...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OCORRENCIA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_OCORRENCIA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_OCORRENCIA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_OCORRENCIA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_OCORRENCIA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_OCORRENCIA actions', async () => {
      const arg = 42666;
