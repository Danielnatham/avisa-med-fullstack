            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('dataNascimento')}>
                  Data Nascimento <FontAwesomeIcon icon={getSortIconByFieldName('dataNascimento')} />
                </th>
                <th className="hand" onClick={sort('email')}>
                  Email <FontAwesomeIcon icon={getSortIconByFieldName('email')} />
                </th>
                <th className="hand" onClick={sort('cpf')}>
                  Cpf <FontAwesomeIcon icon={getSortIconByFieldName('cpf')} />
                </th>
                <th className="hand" onClick={sort('senha')}>
                  Senha <FontAwesomeIcon icon={getSortIconByFieldName('senha')} />
                </th>
                <th />
              </tr>
            </thead>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {usuario.dataNascimento ? (
                      <TextFormat type="date" value={usuario.dataNascimento} format={APP_LOCAL_DATE_FORMAT} />
                    ) : null}
                  </td>
                  <td>{usuario.email}</td>
                  <td>{usuario.cpf}</td>
