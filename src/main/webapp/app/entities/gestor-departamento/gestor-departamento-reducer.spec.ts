...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './gestor-departamento.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GESTORDEPARTAMENTO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GESTORDEPARTAMENTO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GESTORDEPARTAMENTO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_GESTORDEPARTAMENTO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_GESTORDEPARTAMENTO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GESTORDEPARTAMENTO actions', async () => {
      const arg = 42666;
